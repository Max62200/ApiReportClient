 ...
 */
final class Version20211216105302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE report_client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_id INTEGER DEFAULT NULL, service_id INTEGER DEFAULT NULL, file_report_id INTEGER DEFAULT NULL, adresse VARCHAR(255) NOT NULL COLLATE BINARY, ville VARCHAR(255) NOT NULL COLLATE BINARY, cp INTEGER NOT NULL, datetime DATETIME NOT NULL, description CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , CONSTRAINT FK_EEB7D1CA19EB6921 FOREIGN KEY (client_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EEB7D1CAED5CA9E6 FOREIGN KEY (service_id) REFERENCES categories (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EEB7D1CAC5DD1BB6 FOREIGN KEY (file_report_id) REFERENCES media_object (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EEB7D1CAC5DD1BB6 ON report_client (file_report_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_EEB7D1CA19EB6921');
        $this->addSql('DROP INDEX IDX_EEB7D1CAED5CA9E6');
        $this->addSql('DROP INDEX UNIQ_EEB7D1CAC5DD1BB6');
        $this->addSql('CREATE TEMPORARY TABLE __temp__report_client AS SELECT id, client_id, service_id, adresse, ville, cp, datetime, description, created_at, updated_at FROM report_client');
        $this->addSql('DROP TABLE report_client');
